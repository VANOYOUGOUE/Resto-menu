    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between">
      ...
      <main className="flex-grow max-w-6xl w-full mx-auto px-6 py-12 flex flex-col gap-10 justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
          ...
          <div className="p-6 rounded-3xl glass-morphism flex flex-col justify-between gap-6 hover:border-slate-800 transition-all group animate-slide-up" style={{ animationDelay: '0.1s' }}>
            <div className="flex flex-col gap-3">
              <div className="w-12 h-12 rounded-2xl bg-amber-600/10 border border-amber-600/30 flex items-center justify-center text-amber-500 group-hover:scale-110 transition-transform">
                <QrCode size={24} />
              </div>
            ...
            <div className="flex flex-col gap-2 mt-4">
              <span className="text-[10px] uppercase font-bold text-slate-500 tracking-wider">Sélectionnez une table à simuler :</span>
              <div className="grid grid-cols-2 gap-2">
                <button
                  onClick={() => router.push('/q/tb1')}
                  className="px-3 py-2 bg-slate-900 hover:bg-slate-850 border border-slate-800/80 rounded-xl text-xs font-semibold text-slate-200 transition-colors text-left flex items-center justify-between"
                >
                  <span>Table 1</span>
                  <span className="text-[8px] text-amber-500 bg-amber-500/10 px-1.5 py-0.5 rounded font-mono">tb1</span>
                </button>
                <button
                  onClick={() => router.push('/q/tb2')}
                  className="px-3 py-2 bg-slate-900 hover:bg-slate-850 border border-slate-800/80 rounded-xl text-xs font-semibold text-slate-200 transition-colors text-left flex items-center justify-between"
                >
                  <span>Table 2</span>
                  <span className="text-[8px] text-amber-500 bg-amber-500/10 px-1.5 py-0.5 rounded font-mono">tb2</span>
                </button>
                <button
                  onClick={() => router.push('/q/tb3')}
                  className="px-3 py-2 bg-slate-900 hover:bg-slate-850 border border-slate-800/80 rounded-xl text-xs font-semibold text-slate-200 transition-colors text-left flex items-center justify-between"
                >
                  <span>Table 3</span>
                  <span className="text-[8px] text-amber-500 bg-amber-500/10 px-1.5 py-0.5 rounded font-mono">tb3</span>
                </button>
                <button
                  onClick={() => router.push('/q/tb4')}
                  className="px-3 py-2 bg-slate-900 hover:bg-slate-850 border border-slate-800/80 rounded-xl text-xs font-semibold text-slate-200 transition-colors text-left flex items-center justify-between"
                >
                  <span>Table 4</span>
                  <span className="text-[8px] text-amber-500 bg-amber-500/10 px-1.5 py-0.5 rounded font-mono">tb4</span>
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 rounded-3xl glass-morphism flex flex-col justify-between gap-6 hover:border-slate-800 transition-all group animate-slide-up" style={{ animationDelay: '0.2s' }}>
            ...
            <button
              ...
              className="w-full mt-6 py-3.5 bg-blue-600 hover:bg-blue-500 text-slate-950 font-black rounded-xl text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 tap-feedback shadow-lg shadow-blue-600/10"
            >
              <Monitor size={16} />
          ...
          <div className="p-6 rounded-3xl glass-morphism flex flex-col justify-between gap-6 hover:border-slate-800 transition-all group animate-slide-up" style={{ animationDelay: '0.3s' }}>
            ...
            <button
              ...
              className="w-full mt-6 py-3.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-black rounded-xl text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 tap-feedback shadow-lg shadow-amber-500/10"
            >
        ...
        <div className="p-5 rounded-2xl bg-slate-900/40 border border-slate-900 text-xs text-slate-400 flex gap-4 items-start max-w-xl mx-auto animate-slide-up" style={{ animationDelay: '0.4s' }}>
          ...
          <div>
            <span className="font-semibold text-slate-350 block mb-1">Architecture hybride Supabase / LocalStorage</span>
